...
class LevelWonScene: SKScene {
    ...
    override init(size: CGSize) {
        ...
        stessHighNode = SKSpriteNode(imageNamed: Constants.cushedIt)
    ...
    override func didMove(to view: SKView) {
        ...
        playerModel.animateWon()
        UserConfig.shared.incrementLevel()
        
        run(SKAction.playSoundFileNamed("won.mp3", waitForCompletion: false), withKey: "wonSound")
